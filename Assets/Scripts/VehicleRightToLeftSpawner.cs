...
public class VehicleRightToLeftSpawner : MonoBehaviour
{
    [SerializeField] private GameObject[] _vehiclePrefabs;

    private int _vehiclePositionX = -5, _vehiclePositionY = 0, _vehiclePositionZ = -8;
    private int _vehicleRotationXAndZ = 0, _vehicleRotationY = 0;
